...
int daxpyRef(int *n, double *da, double *dx, int *incx, double *dy, int *incy) {
  /* Local variables */
  int i, m, ix, iy, mp1;
...
int dcopyRef(int *n, double *dx, int *incx, double *dy, int *incy) {
  /* Local variables */
  int i, m, ix, iy, mp1;
...
double ddotRef(int *n, double *dx, int *incx, double *dy, int *incy) {
  /* Local variables */
  int i, m;
  double dtemp;
  int ix, iy;
...
int dscalRef(int *n, double *da, double *dx, int *incx) {
