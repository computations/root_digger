...
public:
  ...
  model_t(rooted_tree_t                      t,
      ...
      model_t(t,
              msa,
              rate_cats,
              std::vector<rate_category::rate_category_e>(rate_cats.size(),
                                                          rate_category::MEAN),
              invariant_sites,
              seed,
              early_stop){};
  ...
  std::pair<root_location_t, double> search(size_t min_roots,
                                            double root_ratio,
                                            double atol,
                                            double pgtol,
                                            double brtol,
  ...
  std::pair<root_location_t, double> exhaustive_search(
      double atol, double pgtol, double brtol, double factor, checkpoint_t &);
...
private:
  std::pair<root_location_t, double> bisect(const root_location_t &beg,
                                            dlh_t                  d_beg,
  ...
  std::pair<root_location_t, double> brents(root_location_t beg,
                                            dlh_t           d_beg,
                                            root_location_t end,
                                            dlh_t           d_end,
                                            double          atol);
